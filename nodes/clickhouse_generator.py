...
def clickhouse_generator_node(state: AgentState) -> dict:
    ...
    try:
        ...
        try:
            ...
            idx_start = next(i for i, col in enumerate(sql_result_columns) if col in ["start_date",
                                                                                      "start_time",
                                                                                      "campaign_start"])
            idx_end = next(i for i, col in enumerate(sql_result_columns) if col in ["end_date",
                                                                                    "end_time",
                                                                                    "campaign_end"])
            has_dates = True
